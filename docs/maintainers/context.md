...
- Active task: A001 (M1 reproducible setup and fast validation).
...
- M1 is approved to pin source identity, make setup idempotent, add fast and metadata CI, and define compatibility/versioning policy without changing guest runtime behavior.
