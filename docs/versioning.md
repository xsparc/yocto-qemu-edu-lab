...
| `0.7.0-dev` | 6.0.2 | `wrynose` | A008/M7 is in progress. Manifest schema 2 declares the exact per-lab project package/license profile, and SPDX image-evidence schema 1 binds a clean revision to the locked SPDX 3.0.1 image graph and independently recomputed artifact hashes. Full dual-lab build evidence, reviews, publication, merge, tag, and release remain pending. |
