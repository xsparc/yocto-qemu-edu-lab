...
| `0.4.0-dev` | 6.0.2 | `wrynose` | Clean commit `8574eaf` completed the exact locked image path and passed ping, SSH, and all 19 project cases under software QEMU with validated version-3 evidence; draft pull request #6 passed hosted Fast checks and Yocto metadata at `fbb2cab`; required reviews, merge, tag, and release remain pending |
