...
| `0.5.0-dev` | 6.0.2 | `wrynose` | A005 implementation is in progress. ARM64 `virt`, lab-manifest, platform guest-interface version 1, and platform evidence version 1 compatibility remain unqualified until both clean lab build/runtime paths and required reviews pass. PCI evidence versions 1 through 3 remain the known-good contracts. |
