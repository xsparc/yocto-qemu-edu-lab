...
| `0.5.0-dev` | 6.0.2 | `wrynose` | Clean exact revision `3244a0c` passed all 141 Linux tests without skips, both metadata profiles, the dual-machine layer audit, clean project driver/image reruns, and software-QEMU suites containing all 19 PCI and nine ARM64 project cases. Closed PCI-v3 and platform-v1 evidence validates against that revision. Required reviews and hosted pull-request gates remain open; no tag or release is implied. |
