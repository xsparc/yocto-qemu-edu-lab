...
| `0.3.1-dev` | 6.0.2 | `wrynose` | A007 backports the upstream EDU DMA bounds fix to the host emulator while preserving guest interface and evidence schema 2; build and runtime qualification remain pending until recorded in the active task |
